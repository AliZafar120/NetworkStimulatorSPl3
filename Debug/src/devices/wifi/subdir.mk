...
./src/devices/wifi/jakes-propagation-loss-model.o \
...
./src/devices/wifi/nqap-wifi-mac.o \
./src/devices/wifi/nqsta-wifi-mac.o \
./src/devices/wifi/onoe-wifi-manager.o \
./src/devices/wifi/propagation-delay-model.o \
./src/devices/wifi/propagation-loss-model.o \
./src/devices/wifi/qadhoc-wifi-mac.o \
./src/devices/wifi/qap-wifi-mac.o \
./src/devices/wifi/qos-tag.o \
./src/devices/wifi/qos-utils.o \
./src/devices/wifi/qsta-wifi-mac.o \
...
./src/devices/wifi/jakes-propagation-loss-model.d \
...
./src/devices/wifi/nqap-wifi-mac.d \
./src/devices/wifi/nqsta-wifi-mac.d \
./src/devices/wifi/onoe-wifi-manager.d \
./src/devices/wifi/propagation-delay-model.d \
./src/devices/wifi/propagation-loss-model.d \
./src/devices/wifi/qadhoc-wifi-mac.d \
./src/devices/wifi/qap-wifi-mac.d \
./src/devices/wifi/qos-tag.d \
./src/devices/wifi/qos-utils.d \
./src/devices/wifi/qsta-wifi-mac.d \
