...
const string Myproto2::BESTPATH = "bestPath";
const string Myproto2::EPRETURN = "ePReturn";
const string Myproto2::EPROVQUERY = "eProvQuery";
const string Myproto2::ERRETURN = "eRReturn";
const string Myproto2::ERULEQUERY = "eRuleQuery";
const string Myproto2::EBESTPATH = "ebestPath";
const string Myproto2::EBESTPATHDELETE = "ebestPathDelete";
const string Myproto2::EBESTPATHTEMP = "ebestPathTemp";
const string Myproto2::EBESTPATHTEMPDELETE = "ebestPathTempDelete";
const string Myproto2::EPATH = "epath";
const string Myproto2::EPATHDELETE = "epathDelete";
const string Myproto2::EPATHTEMP = "epathTemp";
const string Myproto2::EPATHTEMPDELETE = "epathTempDelete";
const string Myproto2::LINK = "link";
const string Myproto2::PITERATE = "pIterate";
const string Myproto2::PQLIST = "pQList";
const string Myproto2::PRESULTTMP = "pResultTmp";
const string Myproto2::PRETURN = "pReturn";
const string Myproto2::PATH = "path";
const string Myproto2::PROV = "prov";
const string Myproto2::PROVQUERY = "provQuery";
const string Myproto2::RITERATE = "rIterate";
const string Myproto2::RQLIST = "rQList";
const string Myproto2::RRESULTTMP = "rResultTmp";
const string Myproto2::RRETURN = "rReturn";
const string Myproto2::RULEEXEC = "ruleExec";
const string Myproto2::RULEQUERY = "ruleQuery";

NS_LOG_COMPONENT_DEFINE ("Myproto2");
NS_OBJECT_ENSURE_REGISTERED (Myproto2);

TypeId
Myproto2::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::rapidnet::myproto2::Myproto2")
    .SetParent<RapidNetApplicationBase> ()
    .AddConstructor<Myproto2> ()
    ;
  return tid;
}
...
void
Myproto2::StartApplication (void)
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StartApplication ();
  RAPIDNET_LOG_INFO("Myproto2 Application Started");
}

void
Myproto2::StopApplication ()
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StopApplication ();
  RAPIDNET_LOG_INFO("Myproto2 Application Stopped");
}

void
Myproto2::InitDatabase ()
{
...
void
Myproto2::DemuxRecv (Ptr<Tuple> tuple)
{
...
void
Myproto2::Prov_r1_1Eca0Ins (Ptr<Tuple> link)
{
...
void
Myproto2::Prov_r1_1Eca0Del (Ptr<Tuple> link)
{
...
void
Myproto2::Prov_r1_2_ecaAdd (Ptr<Tuple> epathTemp)
{
...
void
Myproto2::Prov_r1_2_ecaDel (Ptr<Tuple> epathTempDelete)
{
...
void
Myproto2::Prov_r1_3_ecaAdd (Ptr<Tuple> epathTemp)
{
...
void
Myproto2::Prov_r1_3_ecaDel (Ptr<Tuple> epathTempDelete)
{
...
void
Myproto2::Prov_r1_4_ecaAdd (Ptr<Tuple> epath)
{
...
void
Myproto2::Prov_r1_4_ecaDel (Ptr<Tuple> epathDelete)
{
...
void
Myproto2::Prov_r1_5_ecaAdd (Ptr<Tuple> epath)
{
...
void
Myproto2::Prov_r1_5_ecaDel (Ptr<Tuple> epathDelete)
{
...
void
Myproto2::Prov_r2_1Eca0Ins (Ptr<Tuple> link)
{
...
void
Myproto2::Prov_r2_1Eca0Del (Ptr<Tuple> link)
{
...
void
Myproto2::Prov_r2_1Eca3Ins (Ptr<Tuple> bestPath)
{
...
void
Myproto2::Prov_r2_1Eca3Del (Ptr<Tuple> bestPath)
{
...
void
Myproto2::Prov_r3_1Eca0Ins (Ptr<Tuple> bestPath)
{
...
void
Myproto2::Prov_r3_1Eca0Del (Ptr<Tuple> bestPath)
{
...
void
Myproto2::Prov_r3_2_ecaAdd (Ptr<Tuple> ebestPathTemp)
{
...
void
Myproto2::Prov_r3_2_ecaDel (Ptr<Tuple> ebestPathTempDelete)
{
...
void
Myproto2::Prov_r3_3_ecaAdd (Ptr<Tuple> ebestPathTemp)
{
...
void
Myproto2::Prov_r3_3_ecaDel (Ptr<Tuple> ebestPathTempDelete)
{
...
void
Myproto2::R3eca2 (Ptr<Tuple> path)
{
...
void
Myproto2::Prov_r3_5_ecaAdd (Ptr<Tuple> ebestPath)
{
...
void
Myproto2::Prov_r3_5_ecaDel (Ptr<Tuple> ebestPathDelete)
{
...
void
Myproto2::Prov_edb_1Eca1Ins (Ptr<Tuple> link)
{
...
void
Myproto2::Prov_edb_1Eca1Del (Ptr<Tuple> link)
{
...
void
Myproto2::Edb1_eca (Ptr<Tuple> provQuery)
{
...
void
Myproto2::Idb1_eca (Ptr<Tuple> provQuery)
{
...
void
Myproto2::Idb2_eca (Ptr<Tuple> provQuery)
{
...
void
Myproto2::Idb3_eca (Ptr<Tuple> provQuery)
{
...
void
Myproto2::Idb4_eca (Ptr<Tuple> pIterate)
{
...
void
Myproto2::Idb5_eca (Ptr<Tuple> pIterate)
{
...
void
Myproto2::Idb6_eca (Ptr<Tuple> eRuleQuery)
{
...
void
Myproto2::Idb7_eca (Ptr<Tuple> rReturn)
{
...
void
Myproto2::Idb8Eca0Ins (Ptr<Tuple> pResultTmp)
{
...
void
Myproto2::Idb8Eca1Ins (Ptr<Tuple> pQList)
{
...
void
Myproto2::Idb9_eca (Ptr<Tuple> ePReturn)
{
...
void
Myproto2::Rv1_eca (Ptr<Tuple> ruleQuery)
{
...
void
Myproto2::Rv2_eca (Ptr<Tuple> ruleQuery)
{
...
void
Myproto2::Rv3_eca (Ptr<Tuple> ruleQuery)
{
...
void
Myproto2::Rv4_eca (Ptr<Tuple> rIterate)
{
...
void
Myproto2::Rv5_eca (Ptr<Tuple> rIterate)
{
...
void
Myproto2::Rv6_eca (Ptr<Tuple> eProvQuery)
{
...
void
Myproto2::Rv7_eca (Ptr<Tuple> pReturn)
{
...
void
Myproto2::Rv8Eca0Ins (Ptr<Tuple> rResultTmp)
{
...
void
Myproto2::Rv8Eca1Ins (Ptr<Tuple> rQList)
{
...
void
Myproto2::Rv9_eca (Ptr<Tuple> eRReturn)
{
