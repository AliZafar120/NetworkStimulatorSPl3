...
class Bogonlist : public RapidNetApplicationBase
{
public:
  static const string ADVERTISE;
  static const string BESTPATH;
  static const string IMPORTFILTER;
  static const string LINK;
  static const string NEIGHBOUR;
  static const string PATH;
  static const string PATHDELETE;
  static const string PERIODIC;
  static const string R0_ECAPERIODIC;
...
protected:
  ...
  virtual void R0_ecaperiodic ();

  virtual void R0_eca (Ptr<Tuple> r0_ecaperiodic);

  virtual void R5Eca0Ins (Ptr<Tuple> link);

  virtual void R5Eca0Del (Ptr<Tuple> link);

  virtual void R5Eca1Ins (Ptr<Tuple> importfilter);

  virtual void R5Eca1Del (Ptr<Tuple> importfilter);

  virtual void R6_eca (Ptr<Tuple> advertise);
  ...
  EventId m_event_r0_ecaperiodic;
};
